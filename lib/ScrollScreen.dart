...
//////////////// third circul  and dots ////////////////////
                      ...
                      Positioned(
                          top: height * 0.825,
                          left: width * 0.2,
                          child: Text('with our seamless online platfrom',
                              style: TextStyle(
                                  fontSize: 13,
                                  fontWeight: FontWeight.bold,
                                  color: Color.fromARGB(255, 124, 107, 107)))),
...
// Next Button
            ...
            return InkWell(
              onTap: () {
                if (controller.currentPage.value < 2) {
                  ...
                  Get.to(
                      LanguageSelectionScreen()); // Replace `NewPage` with the page you want to navigate to
                }
              },
              child: Container(
                height: height * 0.06,
  ...
  Widget _buildPageContent(Color color, String text) {
    return Container(
      color: color,
      child: Center(
        child: Text(
...
//////////// yea class hm na scroll sa nikl ke langauge screen pa lea jya geee oper language vli screen ko cell kiya hova hy ///////////////////////////
